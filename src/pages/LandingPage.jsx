            ...
            <main>
                    ...
                    <div className="bg-neutral-800/50 pb-20 outline outline-white/5 sm:pb-24 xl:pb-0">
                        <div
                            ...
                            <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                                <div
                                    className="relative aspect-2/1 h-full after:absolute after:inset-0 after:rounded-2xl after:inset-ring after:inset-ring-white/15 md:-mx-8 xl:mx-0 xl:aspect-auto">
                                    <img
                                        alt=""
                                ...
                                <figure className="relative isolate pt-6 sm:pt-12">
                                    ...
                                    <blockquote className="text-xl/8 font-semibold text-neutral-100 sm:text-2xl/9">
                                        <p>
                                            ...
                                            enim nunc suscipit
                                            tincidunt nunc. Et non lorem tortor posuere. Nunc eu scelerisque interdum
                                            eget tellus non nibh
                ...
                <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
                    <div className="mx-auto max-w-4xl">
                        <h2 className="text-4xl font-semibold tracking-tight text-white sm:text-5xl">Frequently asked
                            questions</h2>
