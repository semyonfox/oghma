  ...
  return (
    <div className="overflow-hidden rounded-radius-lg border border-border-subtle bg-surface/20">
      ...
      >
        ...
        <span className="flex-1 text-sm font-medium text-text-tertiary">
          {label}
        </span>
        ...
        >
          {thinking && (
            <div className="mb-1.5 border-l border-primary-500/25 pl-2.5">
              ...
              <p className="max-h-48 overflow-y-auto whitespace-pre-wrap text-sm italic leading-relaxed text-text-tertiary obsidian-scrollbar">
                {thinking}
              </p>
            </div>
          )}
          ...
          {parts.map((part, index) =>
            part.type === "tool" ? (
              <div
                ...
                className="flex items-start gap-2 py-1 text-sm text-text-tertiary"
              >
                <span
              ...
              <p
                key={`narration-${index}`}
                className="border-l border-border-subtle py-1 pl-2.5 text-sm italic leading-relaxed text-text-tertiary"
              >
                {part.text}
              </p>
            ) : (
