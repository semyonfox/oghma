...
export default function Example() {
  return (
    <div className="lg:flex lg:h-full lg:flex-col">
      <header className="flex items-center justify-between border-b border-neutral-200 dark:border-white/10 bg-neutral-100 dark:bg-neutral-800/50 px-6 py-4 lg:flex-none">
        <h1 className="text-base font-semibold text-neutral-900 dark:text-white">
          <time dateTime="2022-01">January 2022</time>
        </h1>
        <div className="flex items-center">
          <div className="relative flex items-center rounded-md bg-neutral-200 dark:bg-white/10 outline -outline-offset-1 outline-neutral-300 dark:outline-white/5 md:items-stretch">
            <button
              type="button"
          ...
          <Menu as="div" className="relative ml-6 md:hidden">
            <MenuButton className="-mx-2 flex items-center rounded-full border border-transparent p-2 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white">
      ...
      <div className="ring-1 ring-neutral-200 dark:ring-white/5 lg:flex lg:flex-auto lg:flex-col">
        <div className="grid grid-cols-7 gap-px border-b border-neutral-200 dark:border-white/5 bg-neutral-200 dark:bg-white/15 text-center text-xs/6 font-semibold text-neutral-700 dark:text-neutral-300 lg:flex-none">
                ...
                {day.events.length > 0 ? (
                  <span className="-mx-0.5 mt-auto flex flex-wrap-reverse">
                    {day.events.map((event) => (
                      <span
                        key={event.id}
                        className="mx-0.5 mb-1 size-1.5 rounded-full bg-neutral-500"
                      />
                    ))}
                  </span>
                ) : null}
      ...
      <div className="relative px-4 py-10 after:pointer-events-none after:absolute after:inset-x-0 after:top-0 after:h-px after:bg-neutral-200 dark:after:bg-white/10 sm:px-6 lg:hidden">
        <ol className="divide-y divide-neutral-200 dark:divide-white/10 overflow-hidden rounded-lg bg-neutral-100 dark:bg-neutral-800/50 text-sm outline-1 -outline-offset-1 outline-neutral-200 dark:outline-white/10">
          {events.map((event) => (
            <li
              key={event.id}
              className="group flex p-4 pr-6 focus-within:bg-neutral-200 dark:focus-within:bg-white/5 hover:bg-neutral-200 dark:hover:bg-white/5"
            >
              <div className="flex-auto">
                ...
                <time
                  dateTime={event.datetime}
                  className="mt-2 flex items-center text-neutral-700 dark:text-neutral-300"
                >
                  <ClockIcon
                    aria-hidden="true"
                    className="mr-2 size-5 text-neutral-500"
                  />
                  {event.time}
                </time>
              </div>
