...
const TodoTab: FC = () => {
  ...
  return (
    <div className="p-4 space-y-4">
      {/* Daily Summary */}
      <section>
        <h3 className="text-xs font-semibold text-text-tertiary uppercase mb-3">
          {t("Today's Tasks")}
        </h3>
      ...
      <section>
        ...
        <div className="space-y-2">
          <button className="w-full px-3 py-2 glass-card-interactive rounded-radius-md text-sm text-text-secondary transition-colors flex items-center gap-2">
