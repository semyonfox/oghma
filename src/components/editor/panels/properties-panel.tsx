      ...
      <div className="flex-1 overflow-y-auto">
        <div className="space-y-4 p-4">
          ...
          <section className="pt-2 border-t border-gray-700">
            <h4 className="text-xs font-semibold text-gray-500 uppercase mb-2">AI Suggestions</h4>
            <div className="space-y-2">
              <div className="px-3 py-2 bg-indigo-600/10 border border-indigo-600/20 rounded text-xs text-indigo-300">
                <p className="mb-2">💡 Consider adding more examples to strengthen understanding</p>
                <button className="text-indigo-400 hover:text-indigo-200 text-xs font-medium">
                  Apply
                </button>
              </div>
              <div className="px-3 py-2 bg-indigo-600/10 border border-indigo-600/20 rounded text-xs text-indigo-300">
                <p className="mb-2">💡 This concept relates to "Data Structures"</p>
                <button className="text-indigo-400 hover:text-indigo-200 text-xs font-medium">
                  Create Link
                </button>
              </div>
