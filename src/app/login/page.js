...
export default function LoginPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-900 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md">
          <div className="rounded-lg bg-green-500/10 p-8 text-center">
            <h2 className="text-2xl font-bold tracking-tight text-white">
              Login Successful!
            </h2>
            <p className="mt-2 text-gray-300">Redirecting to home...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex min-h-full flex-col justify-center bg-gray-900 py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div className="rounded-lg bg-gray-800/50 px-6 py-12 outline outline-1 -outline-offset-1 outline-white/10 sm:px-12">
          {errMsg && (
            <div
              ref={errRef}
              role="alert"
              className="mb-6 rounded-md bg-red-500/10 p-4 text-red-400 outline outline-1 outline-red-500/20"
            >
