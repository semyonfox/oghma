...
async function keywordSearch(userId: string, query: string, limit = 20): Promise<ResultItem[]> {
    const pattern = `%${query}%`;
...
async function semanticSearch(userId: string, query: string, excludeIds: string[] = [], limit = 10): Promise<ResultItem[]> {
