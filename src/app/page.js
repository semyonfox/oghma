        ...
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">SocsBoard</span>
              <img
                alt=""
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl">
                Study smarter with AI-enhanced learning
              </h1>
              <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
                SocsBoard is an AI-powered learning platform that helps university students organize notes, collaborate on study materials, and leverage intelligent insights to master their coursework.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl sm:text-balance">
              Powerful learning tools for modern students
            </p>
            <p className="mt-6 text-lg/8 text-gray-300">
              SocsBoard combines intelligent AI insights with collaborative learning features, all built on secure cloud infrastructure. Everything you need to excel in your studies.
            </p>
          </div>
          <dl className="mx-auto mt-12 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base/7 text-gray-400 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16 pb-16 sm:pb-20 md:pb-24">
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-800 px-6 py-24 after:pointer-events-none after:absolute after:inset-0 after:inset-ring after:inset-ring-white/15 sm:rounded-3xl sm:px-24 after:sm:rounded-3xl xl:py-32">
            ...
            <p className="mx-auto mt-6 max-w-lg text-center text-lg text-gray-300">
              Join students using SocsBoard to organize notes, collaborate with peers, and master their coursework with AI-powered insights.
            </p>
