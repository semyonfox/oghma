      ...
      <aside className="w-60 flex-shrink-0 flex flex-col border-r border-border-subtle bg-surface">
        ...
        <div className="px-3 py-3">
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-text-tertiary bg-white/5 border border-border-subtle hover:bg-white/8 hover:text-text-secondary transition-colors"
          >
          ...
          {conversations.map((conv) => (
            <button
              ...
              className={`group w-full text-left px-3 py-2.5 rounded-lg text-xs transition-colors ${
                conv.id === activeId
                  ? "bg-primary-500/20 border border-primary-500/30 text-text-secondary"
            ...
            >
              <div className="flex items-start justify-between gap-1">
                ...
                <span
                  ...
                  className="opacity-0 group-hover:opacity-100 p-0.5 text-text-tertiary hover:text-red-400 transition-all flex-shrink-0"
        ...
        <div className="flex-shrink-0 border-t border-border-subtle px-4 py-3">
          <Link
            href="/settings"
            className="text-xs text-text-tertiary hover:text-text-tertiary transition-colors"
          >
            {t("chat.configure_ai")}
          </Link>
        </div>
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            {(activeConv?.noteId || paramNoteId) && (
              <a
                ...
                className="flex items-center gap-1 px-2 py-0.5 rounded-full border border-white/10 bg-white/5 text-[11px] text-text-tertiary hover:text-text-secondary transition-colors"
              >
