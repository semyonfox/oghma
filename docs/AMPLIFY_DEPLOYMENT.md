...
DATABASE_URL=postgresql://user:password@rds-endpoint:5432/socsboard
...
aws rds create-db-instance \
  --db-instance-identifier socsboard-prod \
  --engine postgres \
  --engine-version 15.4 \
...
psql postgresql://socsboard_user:password@socsboard-prod.xxxxx.us-east-1.rds.amazonaws.com:5432/socsboard \
  < database/setup.sql
