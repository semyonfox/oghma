...
2. Configuration:
   - **Bucket name**: `socsboard-prod-files` (must be globally unique)
  ...
  "Statement": [
    {
      ...
      "Resource": [
        "arn:aws:s3:::socsboard-prod-files",
        "arn:aws:s3:::socsboard-prod-files/*"
      ]
    }
  ]
...
**Share with team:**
- STORAGE_BUCKET: `socsboard-prod-files`
...
└── S3
    └── Buckets → Click "socsboard-prod-files"
