...
**Current Deployment:** The platform is currently hosted at https://your-domain.com using a Cloudflare Tunnel. The application runs securely within Docker containers with all databases isolated in a dedicated subnet on a private server infrastructure.
...
- **Hosting:** Self-hosted server accessible via https://your-domain.com
...
- Deployment to production server (https://your-domain.com)
