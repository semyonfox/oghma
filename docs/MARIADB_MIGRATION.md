...
# 4. Update .env file
DATABASE_URL=mysql://socsboard:socsboard@localhost:3306/socsboard
DATABASE_HOST=localhost
DATABASE_PORT=3306
DATABASE_USER=socsboard
DATABASE_PASSWORD=socsboard
DATABASE_NAME=socsboard
```
...
services:
  ...
  web:
    ...
    depends_on:
      - mariadb
    environment:
      DATABASE_URL: mysql://socsboard_user:${MARIADB_PASSWORD}@mariadb:3306/socsboard
    ports:
      - "3000:3000"
    networks:
      ct2106:
...
DATABASE_URL=postgresql://postgres:postgres@localhost:5432/socsboard
