...
You need to configure your Cloudflare Tunnel to route `ct216.semyon.ie` to the ct216 web container at
`172.30.10.8:3000`.
...
- **Public URL**: https://ct216.semyon.ie
- **Internal IP**: 172.30.10.8
- **Internal Port**: 3000
- **Health Check**: https://ct216.semyon.ie/api/health
