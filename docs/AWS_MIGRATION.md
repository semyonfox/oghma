...
**URL Changes:**
```
BEFORE: https://ct216.semyon.ie/api/auth/login
...
postgresql://user:pass@100.118.61.122:2345/socsboard

// AFTER: From AWS Secrets Manager
const secrets = await getSecret('socsboard/rds-credentials');
postgresql://${secrets.username}:${secrets.password}@
...
DATABASE_URL="postgresql://${USER}:${PASSWORD}@${ENDPOINT}:${PORT}/${DATABASE}"
...
# Test connection:
psql postgresql://socsboard_user:your-password@\
socsboard-db.xxxxx.us-east-1.rds.amazonaws.com:5432/socsboard
...
# Name: ct216.semyon.ie (or your domain)
# Type: CNAME
