...
\textbf{Current Deployment:} The platform is currently hosted at \url{https://your-domain.com} using a Cloudflare Tunnel. The application runs securely within Docker containers with all databases isolated in a dedicated subnet on a private server infrastructure.
...
\begin{itemize}
    \item \textbf{Hosting:} Self-hosted server accessible via \url{https://your-domain.com}
...
\begin{itemize}
    ...
    \item Deployment to production server (\url{https://your-domain.com})
\end{itemize}
