...
aws lambda create-function \
  ...
  --timeout 30 \
  --memory-size 512 \
  --environment Variables="{DATABASE_URL=postgresql://<redacted>"
```
...
```bash
aws ecs create-cluster --cluster-name your-bucket-name
```
...
3. `DATABASE_URL` format correct: `postgresql://<redacted>
