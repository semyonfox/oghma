...
3. Connection string: `postgres://user:password@localhost:5432/socsboard`
...
Example:
postgres://socsboard_user:SecurePass123@db.neon.tech:5432/socsboard
```
...
```
postgres://shared_user:password@dev-db.neon.tech:5432/socsboard_dev
```

**B. Use personal database:**
```
postgres://dev_john:password@localhost:5432/socsboard_john
```

**C. Use Neon branch (automatic):**
```
postgres://user:password@feature-branch.neon.tech:5432/socsboard
```
...
```
postgres://prod_user:SecurePassword@prod-db.abc123.rds.amazonaws.com:5432/socsboard
```
